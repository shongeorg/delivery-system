...
async function seed() {
  ...
  // Create categories
  const categoryData = [
    { name: 'Pizza', description: 'Delicious Italian pizzas', cover: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?w=500' },
    { name: 'Burgers', description: 'Juicy burgers', cover: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=500' },
    { name: 'Sushi', description: 'Fresh Japanese sushi', cover: 'https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?w=500' },
    { name: 'Salads', description: 'Healthy salads', cover: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=500' },
    { name: 'Desserts', description: 'Sweet treats', cover: 'https://images.unsplash.com/photo-1551024601-bec78aea704b?w=500' },
  ];
